        ...
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                ...
                <div class="container4">
                    ...
                    <div class="text4">
                        <p class="mb-0">Tempat Pemasangan Sensor berada tidak jauh dari bendungan pice  berada di sisi sungai lenggang tepatnya pada pertemuan antara air laut dan air sungai dari bendungan pice.</p>
                    </div>
                </div>
               </div>
            </div>
